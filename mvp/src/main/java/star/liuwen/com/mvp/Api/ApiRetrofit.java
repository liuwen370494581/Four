...
import star.liuwen.com.mvp.Base.MyApp;
...
//    };
    ...
    private Interceptor mLogInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            Log.e("MainActivity", "----------Request Start----------------");
            Log.e("MainActivity", "| " + request.toString());
            Log.e("MainActivity", "| Response:" + content.toString());
            Log.e("MainActivity", "----------Request End:" + duration + "毫秒----------");
